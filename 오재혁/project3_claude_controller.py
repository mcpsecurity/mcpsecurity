...
if __name__ == "__main__":
    print("🔍 민감한 데이터 스캐너 MCP 서버가 시작되었습니다.")
    print("포트: 5004")
    print("사용 가능한 도구:")
    print("- scan_sensitive_data: 민감한 데이터 스캔")
    print("- scan_specific_file: 특정 파일 스캔")
    print("- get_scan_patterns: 검색 패턴 조회")
    print("\n⚠️ 주의: 이 도구는 민감한 데이터를 다룹니다. 신중하게 사용하세요.")
